...
// This separate ecosystem is intentionally opt-in. Never import it into the
// ordinary Feishu ecosystem: projection needs an explicit history policy and
// a successful one-shot canary before an operator starts the supervisor.
module.exports = {
  apps: [{
